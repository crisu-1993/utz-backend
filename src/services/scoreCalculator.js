...
/**
 * scoreCalculator.js — módulo hoja puro
 *
 * Lógica de cálculo del UTZ Finance Score extraída de src/routes/score.js
 * para ser reutilizada por Niko sin duplicar código.
 *
 * NO importa express ni el router. Solo cálculo + supabase.
 */
...
// ─── Helpers de puntos por indicador ─────────────────────────────────────────
...
async function calcularMetricas(supabase, empresa_id, año, mes) {
  ...
  // 4. Días cobro: solo informativo — excluido del score
